...
export const NO_STRING_PRICE = /^"price" must be a string$/;

export const SHORT_NAME = /^"name" length must be at least 3 characters long$/;

export const SHORT_PRICE = /^"price" length must be at least 3 characters long$/;